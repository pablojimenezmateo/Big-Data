Working with big data, the smart way
============================
...
* Comparing speedups when using compression with blz btables in disk only [[nbviewer]](http://nbviewer.ipython.org/github/pjimenezmateo/numba-blz-tutorials/blob/master/Btable%20benchmark%20disk%20only.ipynb) [[Wakari]](https://www.wakari.io/sharing/bundle/pjimenezmateo/Btable_benchmarks)
